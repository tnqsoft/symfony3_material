(function (Translator) {
    ...
    Translator.add("The image ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.", "Omjer slike je prevelik ({{ ratio }}). Dozvoljeni maksimalni omjer je {{ max_ratio }}.", "validators", "hr");
    Translator.add("The image ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.", "Omjer slike je premali ({{ ratio }}). Minimalni o\u010dekivani omjer je {{ min_ratio }}.", "validators", "hr");
    Translator.add("The image is square ({{ width }}x{{ height }}px). Square images are not allowed.", "Slika je kvadratnog oblika ({{ width }}x{{ height }}px). Kvadratne slike nisu dozvoljene.", "validators", "hr");
    Translator.add("The image is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented images are not allowed.", "Slika je orijentirana horizontalno ({{ width }}x{{ height }}px). Horizontalno orijentirane slike nisu dozvoljene.", "validators", "hr");
    Translator.add("The image is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented images are not allowed.", "Slika je orijentirana vertikalno ({{ width }}x{{ height }}px). Vertikalno orijentirane slike nisu dozvoljene.", "validators", "hr");
    Translator.add("An empty file is not allowed.", "Prazna datoteka nije dozvoljena.", "validators", "hr");
    Translator.add("The host could not be resolved.", "Poslu\u017eitelj nije mogao biti razrije\u0161en.", "validators", "hr");
    Translator.add("This value does not match the expected {{ charset }} charset.", "Znakovne oznake vrijednosti ne odgovaraju o\u010dekivanom {{ charset }} skupu.", "validators", "hr");
    Translator.add("This is not a valid Business Identifier Code (BIC).", "Ovo nije validan poslovni identifikacijski broj (BIC).", "validators", "hr");
