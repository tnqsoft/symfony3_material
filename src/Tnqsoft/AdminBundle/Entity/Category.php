 ...
 * @ORM\Entity(repositoryClass="Tnqsoft\AdminBundle\Repository\CategoryRepository")
...
class Category
{
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="Tnqsoft\AdminBundle\Entity\News", mappedBy="category")
     */
    private $news;
