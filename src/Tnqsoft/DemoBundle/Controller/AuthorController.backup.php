...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $authors = $em->getRepository('TnqsoftDemoBundle:Author')->findAll();
    ...
    {
        $author = new Author();
        $form = $this->createForm('Tnqsoft\DemoBundle\Form\AuthorType', $author);
    ...
    {
        $deleteForm = $this->createDeleteForm($author);
        $editForm = $this->createForm('Tnqsoft\DemoBundle\Form\AuthorType', $author);
